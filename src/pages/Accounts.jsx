  ...
  if (!mode) {
    return (
      <div className="fixed inset-0 bg-black/80 z-50 flex items-end sm:items-center justify-center"
        onClick={onClose}>
        <div className="bg-[#1a1a2e] border border-[#3a3a5a] rounded-t-2xl sm:rounded-2xl p-5 w-full max-w-md safe-bottom max-h-[80vh] overflow-y-auto"
    ...
    <div className="py-4 space-y-3">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-end sm:items-center justify-center"
          ...
          <div className="bg-[#1a1a2e] border border-[#3a3a5a] rounded-t-2xl sm:rounded-2xl p-6 w-full max-w-md max-h-[80vh] overflow-y-auto safe-bottom"
            onClick={e => e.stopPropagation()}>
